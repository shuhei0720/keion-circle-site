...
この章では、実際に「お知らせ機能」を1から作成していきます。

### Step 1: データモデルの追加

**1-1. Prismaスキーマを更新**

`prisma/schema.prisma` にAnnouncementモデルを追加：
...
Chapter 24の内容を理解できたか確認しましょう。

### 新機能の追加

- [ ] Prismaスキーマにモデルを追加できる
- [ ] データベースにマイグレーションを適用できる
- [ ] API Routeを実装できる（CRUD操作）
...
[← 前の章：第23章 セキュリティ](23-セキュリティ.md) | [目次に戻る](00-目次.md) | [次の章へ：第25章 トラブルシューティング →](25-トラブルシューティング.md)
