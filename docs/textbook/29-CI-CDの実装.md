...
**Continuous Delivery（デリバリー）vs Deployment（デプロイ）:**

| | Continuous Delivery | Continuous Deployment |
|---|---------------------|----------------------|
| 意味 | 継続的デリバリー | 継続的デプロイ |
| デプロイ | 手動ボタン押下 | 完全自動 |
| リスク | 低（人間が最終確認） | 最小（自動テスト）|
| 採用例 | 大企業、金融系 | スタートアップ、SaaS |

**図解:**

```
Continuous Delivery（デリバリー）:
┌──────┐   ┌──────┐   ┌──────┐   ┌──────┐
│コード│→│テスト│→│ビルド│→│[Deploy]│← 手動
└──────┘   └──────┘   └──────┘   └──────┘
                                    ボタン

Continuous Deployment（デプロイ）:
┌──────┐   ┌──────┐   ┌──────┐   ┌──────┐
│コード│→│テスト│→│ビルド│→│デプロイ│← 自動
└──────┘   └──────┘   └──────┘   └──────┘
```
...
> 💡 **初心者への補足:**
> - **CI**: 「コードをpushしたら自動テスト」と覚えましょう
> - **CD**: 「テストが通ったら自動デプロイ」と覚えましょう
> - **CI/CD の目的**: 「高品質なコードを迅速にユーザーに届ける」
