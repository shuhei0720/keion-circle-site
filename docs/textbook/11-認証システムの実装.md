...
`src/app/api/auth/[...nextauth]/route.ts` を開いてください。
...
`src/app/api/auth/signup/route.ts` を作成してください。
...
`src/app/auth/signup/page.tsx` を作成してください。
...
`src/components/Navbar.tsx` を作成してください。
...
プロジェクトルートに `middleware.ts` を作成してください。
...
`src/app/protected/page.tsx` を作成してください。
...
`src/app/admin/page.tsx` を作成してください。
