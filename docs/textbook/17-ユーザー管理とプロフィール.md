...
`src/app/users/page.tsx` を作成してください。
...
ブラウザで http://localhost:3000/users を開いてください。
...
`src/app/api/users/[id]/role/route.ts` を作成してください。
...
`src/app/users/[id]/page.tsx` を作成してください。
...
`src/components/RoleChangeButton.tsx` を作成してください。
...
`src/app/api/profile/route.ts` を作成してください。
...
`src/app/profile/page.tsx` を作成してください。
...
`src/components/ProfileForm.tsx` を作成してください。
