...
`package.json` を開いて、以下のコードを**すべて**入力してください：
...
`src/lib/__tests__` フォルダに `test-helpers.ts` を開いて、以下のコードを**すべて**入力してください：
...
### Step 4: `src/app/api/posts/__tests__/route.integration.test.ts` を開いて、以下のコードを**すべて**入力してください：
