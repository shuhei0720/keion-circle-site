...
`src/app/api/posts/[id]/like/route.ts` を作成してください。
...
`src/app/api/posts/[id]/comments/route.ts` を作成してください。
...
`src/app/api/posts/[id]/comments/[commentId]/route.ts` を作成してください。
...
`src/components/CommentSection.tsx` を作成してください。
