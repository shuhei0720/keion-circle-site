...
## 28.3 Supabase クライアント（src/lib/supabase.ts）
...
[← 前の章：第 27 章 ページコンポーネントの詳細解説](27-ページコンポーネントの詳細解説.md) | [目次に戻る](00-目次.md) | [次の章へ：付録 A 用語集 →](付録A-用語集.md)
