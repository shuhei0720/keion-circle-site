...
`src/components/Footer.tsx` を作成してください。
...
export const metadata: Metadata = {
  ...
  description: '大学軽音楽サークルBOLDのメンバー専用サイト。活動報告、スケジュール調整、イベント管理。',
...
`src/components/ui/Button.tsx` を作成してください。
