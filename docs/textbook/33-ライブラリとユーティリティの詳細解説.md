 ...
 *
 * 提供する認証方法:
 * 1. Google OAuth: Google アカウントでログイン
 * 2. Credentials: メールアドレスとパスワードでログイン
 *
 * セッション戦略:
 * - JWT を使用（データベースセッションは使わない）
 * - Cookie サイズを最小化（ID と role のみ保存）
 */
