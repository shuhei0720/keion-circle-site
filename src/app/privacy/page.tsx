      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-lg p-8">
          ...
          <div className="space-y-6 text-white/80">
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">1. 個人情報の取得について</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">2. 個人情報の利用目的</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">3. 個人情報の第三者提供</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">4. 個人情報の管理</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">5. Cookie（クッキー）について</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">6. アクセス解析ツールについて</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">7. プライバシーポリシーの変更</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">8. お問い合わせ</h2>
              <p className="leading-relaxed">
