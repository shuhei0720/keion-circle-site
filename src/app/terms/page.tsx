    ...
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-lg p-8">
          <h1 className="text-3xl font-bold mb-8 text-white">利用規約</h1>
          ...
          <div className="space-y-6 text-white/80">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第3条（禁止事項）</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第4条（投稿コンテンツ）</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第5条（アカウントの管理）</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第6条（サービスの変更・停止）</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第8条（免責事項）</h2>
              <p className="leading-relaxed">
